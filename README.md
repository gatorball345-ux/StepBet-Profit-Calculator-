...
No. StepCat is an independent calculator and is not affiliated with, endorsed by, or sponsored by StepBet, WayBetter, FitnessAI, or any related company.
...
The rest of the README uses generic wording such as **step challenge**, **challenge host**, **platform fee**, and **step-challenge payout scenarios**.
...
StepCat is not affiliated with, endorsed by, or sponsored by StepBet, WayBetter, FitnessAI, or any related company.

Names of outside companies or services may be mentioned only to clarify that StepCat is independent and to describe the general type of step-challenge payout scenario the calculator estimates.

StepCat does not use outside company logos, does not connect to outside accounts, and does not request login information for any outside service.

Results are estimates based on the information entered by the user. Actual results may vary depending on final eligibility, challenge rules, fees, bonuses, and other official adjustments.
