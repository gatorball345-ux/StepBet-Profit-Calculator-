...
**StepCat Calculator** is a mobile-friendly StepBet payout calculator designed to estimate projected payout, profit, draw, ROI, and player-count outcomes for StepBet challenges.
...
In StepBet games, a true loss happens when a player is disqualified and receives $0.00 back, in addition to forfeiture of their entry fee.
...
Donations are optional. Such contributions are personal support, not tax-deductible charitable donations.
...
No. Donations are optional. Such contributions are personal support, not tax-deductible charitable donations.
...
The project should avoid using StepBet logos, copying StepBet branding, or implying that StepCat is official StepBet software.

The safest wording is:

```text
StepCat is an independent calculator for estimating StepBet-style payout scenarios.
```
